...
import "./analytics.css"; // Add this new CSS file for styles
    ...
    <Container className="mt-5">
      <Row>
        <div className="col-lg-3 col-md-6 mb-4">
          <div className="card analytics-card">
            ...
            <div className="card-body">
              <h5 className="card-title income">
                Income: <ArrowDropUpIcon /> {totalIncomeTransactions.length}
              </h5>
              <h5 className="card-title expense">
        ...
        <div className="col-lg-3 col-md-6 mb-4">
          <div className="card analytics-card">
            <div className="card-header">
              <span>Category-wise Income</span>
            </div>
            <div className="card-body">
              {categories.map(category => {
                ...
                return (
                  income > 0 && <LineProgressBar key={category} label={category} percentage={incomePercent.toFixed(0)} lineColor={colors[category]} />
                );
              })}
            </div>
          </div>
        ...
        <div className="col-lg-3 col-md-6 mb-4">
          <div className="card analytics-card">
            <div className="card-header">
              <span>Category-wise Expense</span>
            </div>
            <div className="card-body">
              {categories.map(category => {
                ...
                return (
                  expenses > 0 && <LineProgressBar key={category} label={category} percentage={expensePercent.toFixed(0)} lineColor={colors[category]} />
                );
              })}
            </div>
          </div>
